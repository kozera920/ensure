...
const UploadVehicleImagesModal = ({ images, setImages,onSave }) => {
  ...
  return (
    <div className="w-full max-w-md sm:max-w-lg px-2 sm:px-4 pt-10 sm:pt-14 pb-4 sm:pb-6 relative bg-white rounded-lg shadow-lg flex flex-col justify-center items-center gap-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex justify-center items-center p-4">
          <div className="relative w-full max-w-sm">
            ...
            <div className="absolute top-1/2 right-0 flex items-center translate-x-full -translate-y-1/2">
              ...
              <button className={cameraBtn + " mr-1"}>
                <Icon icon="solar:camera-outline" width={16} height={16} />
              </button>
            </div>
            {/* Right Bottom */}
      ...
      {/* Save Button */}
      <div className="w-full px-1 flex justify-center items-center gap-2">
        <button className="rounded-[30px] outline outline-1 outline-offset-[-1px] outline-neutral-400/30 flex flex-col justify-start items-start gap-1">
          <div className="px-4 py-2 bg-blue-900 rounded-[50px] flex justify-center items-center gap-2 overflow-hidden">
            <button className="text-center text-white text-xs sm:text-sm font-semibold font-['Open_Sans'] cursor-pointer"
            onClick={onSave}
            >
              Save All
            </button>
...
export default UploadVehicleImagesModal;
