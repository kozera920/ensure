  ...
  <div className="w-full md:w-1/2 flex flex-col justify-center px-8 py-12">
    ...
    <form onSubmit={onSubmit} className="space-y-4">
      <div>
        ...
        <input type="text" className="w-full border rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter Phone number or email" />
      </div>
      <div>
        <label className="block text-sm mb-1">Password</label>
        <div className="relative">
          <input type="password" className="w-full border rounded-md px-4 py-2 pr-10 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Password" />
    ...
    <div className="mt-auto pt-10 text-sm text-gray-600 flex flex-col md:flex-row justify-between items-center">
      <p>
        Having Difficulties?
        <a href="#" className="text-blue-600 hover:underline">Contact E-nsure Support</a>
      </p>
